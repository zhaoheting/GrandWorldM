...
import web.services.learn.exercises.three.entity.Person;
...
public class ThreePointFour {
    ...
    public static void main(String[] args) {
        ...
        s24.setId(10);
        list2.add(s24);
        List<Student> result = new ThreePointFour().intersect(list1, list2);
     ...
     * @return
     */
    private <Student extends Comparable<? super Student>> List<Student> intersect(List<Student> list1,
                                                                                  List<Student> list2) {
